  ...
  return (
    <section ref={containerRef} className="relative h-[980px] overflow-hidden px-4 sm:h-[1120px] sm:px-6 lg:h-[1240px]">
      <div className="sticky top-24 mx-auto flex max-w-7xl flex-col items-center">
        ...
        >
          <div className="rounded-[30px] border border-[#eaeaea] bg-white p-2 shadow-[0_28px_80px_rgba(0,0,0,0.08)] sm:p-3">
            <div className="overflow-hidden rounded-[24px] border border-[#eaeaea] bg-white">
              ...
              <div className="relative bg-white">
                <div className="absolute left-0 right-0 top-0 z-10 h-1 bg-[linear-gradient(90deg,#667eea,#f64f59,#12c2e9)]" />
                {children}
              </div>
            </div>
          </div>
