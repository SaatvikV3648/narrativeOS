...
import { LandingTopWash } from '@/components/ui/background-components';
        ...
        <section className="relative z-10 px-5 pb-12 pt-36 text-center sm:px-8 sm:pt-44">
          <div className="mx-auto max-w-5xl">
            <div className="reveal-up">
              <p className="mx-auto mb-6 inline-flex rounded-full border border-[#eaeaea] bg-white/70 px-4 py-2 text-xs font-bold uppercase tracking-[0.22em] text-[#777777] backdrop-blur-xl">
